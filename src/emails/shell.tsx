  ...
  return (
    <Section style={{ marginTop: "28px" }}>
      ...
      <Text style={{ color: "#475569", fontSize: "14px", lineHeight: 1.6, margin: "0 0 16px" }}>
        Curated gear and services — pay your way. More stories in your inbox soon.
      </Text>
      <Text style={{ fontSize: "14px", lineHeight: 1.8, margin: 0 }}>
        <Link href={withUtm(`${base}/shop`)} style={{ color: "#0f172a", fontWeight: 600 }}>
          Shop all
        </Link>
        {" · "}
        <Link href={withUtm(`${base}/services`)} style={{ color: "#0f172a", fontWeight: 600 }}>
          Services
        </Link>
        {" · "}
        <Link href={withUtm(`${base}/membership`)} style={{ color: "#0f172a", fontWeight: 600 }}>
          Membership
        </Link>
        {" · "}
        <Link href={withUtm(`${base}/open-source`)} style={{ color: "#0f172a", fontWeight: 600 }}>
          Open source
        </Link>
      </Text>
    </Section>
...
function MarketingComplianceFooter({
  base,
        ...
        <Container style={{ margin: "0 auto", maxWidth: "560px" }}>
          ...
          >
            ...
            {showBrandStoryFooter ?
              <BrandMarketingFooter base={base} utmFooterQuery={utmFooterQuery} />
            : null}
          </Section>
          <Section style={{ padding: "20px 8px 0" }}>
            ...
            {showMarketingCompliance ? <MarketingComplianceFooter base={base} /> : null}
          </Section>
        </Container>
      </Body>
    </Html>
