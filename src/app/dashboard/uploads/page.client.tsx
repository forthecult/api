...
// Dynamically import BentoMediaGallery to reduce initial bundle size (~50KB framer-motion)
const BentoMediaGallery = dynamic(
  () =>
    import("~/ui/components/blocks/bento-media-gallery").then(
