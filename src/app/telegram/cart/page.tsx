      ...
      <div className="flex-1 px-4 py-6">
        {itemCount === 0 ? (
          <div className="flex flex-col items-center justify-center py-12">
            <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-[var(--tg-theme-secondary-bg-color,#eee)]">
              <ShoppingCart className="h-10 w-10 text-[var(--tg-theme-hint-color,#999)]" />
            </div>
            <p className="mb-6 text-center text-[var(--tg-theme-text-color,#000)]">
              Your cart is empty.
            </p>
          ...
          <>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-2">
                      <span className="line-clamp-2 text-sm font-medium text-[var(--tg-theme-text-color,#000)]">
                        {item.name}
                      </span>
                      <button
                        type="button"
                        aria-label="Remove"
                        className="shrink-0 rounded p-1 text-[var(--tg-theme-hint-color,#999)] hover:bg-black/10"
                        onClick={() => removeItem(item.id)}
                      >
                        <X className="size-4" />
                      </button>
                    </div>
                    <p className="mt-0.5 text-xs text-[var(--tg-theme-hint-color,#999)]">
                      {item.category}
                    </p>
                    <div className="mt-2 flex items-center justify-between gap-2">
                      <div className="flex items-center rounded border border-[var(--tg-theme-hint-color,#999)]/30">
                        <button
                          type="button"
                      ...
                      <span className="shrink-0 text-sm font-medium text-[var(--tg-theme-text-color,#000)]">
            ...
            <div className="mt-8 border-t border-[var(--tg-theme-hint-color,#999)]/20 pt-6">
              <div className="mb-4 flex items-center justify-between text-[var(--tg-theme-text-color,#000)]">
