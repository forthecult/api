...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  if (isAgent) {
    return [
      { url: siteUrl, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
      { url: `${siteUrl}/for-agents`, lastModified: now, changeFrequency: "weekly", priority: 1 },
    ];
  }
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${siteUrl}/esim`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${siteUrl}/membership`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
