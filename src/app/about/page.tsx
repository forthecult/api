        ...
        <div className="space-y-10">
          ...
          <section className="rounded-lg border border-border bg-card/50 px-5 py-5 sm:px-6">
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              physical bitcoins to cypherpunks and early adopters who believed
              in a decentralized future. We've survived bear markets, exchange
              blowups, and every &quot;crypto is dead&quot; headline. We're
              still here.
            </p>
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              We're building the commercial infrastructure for the life you
              actually want — and we're not going anywhere.
            </p>
          </section>
          ...
          <section className="rounded-lg border border-border bg-card/50 px-5 py-5 sm:px-6">
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              verifiable on-chain. Pay with your wallet. Become a CULT member
              for free shipping, early access, and exclusive drops. Your keys,
          ...
          <section className="rounded-lg border border-border bg-card/50 px-5 py-5 sm:px-6">
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              The clothes you wear and the products you touch become part of
              you. We curate apparel made from natural fibers — organic cotton,
              bamboo, alpaca — not polyester and synthetic blends that increase
              cancer risks and belong in the past. Premium coffee, clean water
              filters, red light therapy, gear that lasts. Fashionable and
              actually safe. We want you looking good and feeling better, for
              the long run.
            </p>
          </section>
          ...
          <section className="rounded-lg border border-border bg-card/50 px-5 py-5 sm:px-6">
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              from pump.fun to the next wave. If you're plugged in, you're in
              the right place.
            </p>
            <p className="mt-3 leading-relaxed text-muted-foreground">
              We ship to 100+ countries. Free shipping for members over
              threshold. Crypto or card — your choice. Questions? Hit us up.
