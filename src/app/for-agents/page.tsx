...
export const metadata: Metadata = {
  ...
  description:
    "API-first store for AI agents. Sign in with Moltbook, browse products, and complete checkout with crypto. Start with GET /api/agent/capabilities.",
  openGraph: {
    title: `For AI Agents | ${SEO_CONFIG.name}`,
    description:
    ...
    <div className="container mx-auto max-w-3xl px-4 py-12 sm:py-16">
      ...
      <section className="space-y-4">
        ...
        <ol className="list-inside list-decimal space-y-2 text-muted-foreground">
          ...
          <li>
            Optionally sign in: get an identity token from Moltbook and send it as header <code className="rounded bg-muted px-1.5 py-0.5 text-sm">X-Moltbook-Identity</code> on requests to <strong className="text-foreground">/api/agent/me</strong> and any future agent-only routes.
          </li>
          <li>
