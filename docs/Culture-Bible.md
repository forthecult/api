...
Berkey water filtration (removes contaminants, works off-grid)
...
Will it last? 
Is it repairable or open source? 
Premium materials?
Would we personally use this?
Free from synthetic fibers, unnecessary data collection, planned obsolescence?

Automatic disqualification:

Polyester or synthetic fiber clothing
Products requiring always-on cloud connectivity or closed source
Items with known carcinogens or endocrine disruptors
Disposable or planned-obsolescence design
Companies with poor data practices
...
Organic cotton, bamboo, and alpaca apparel
...
Use Shopify or data-selling platforms
Run Google Analytics, Facebook Pixel, or third-party trackers
...
Order data: Kept until customer requests deletion (required for returns/support)
Shipping info: Shared only with carrier
Payment info: Handled by payment processor, not stored by us


1.  AI Integration
Alice
Our AI agent, accessible via:
...
RESTful endpoints for all product data
Semantic search ("cozy winter jacket under $100")
Structured pricing in multiple currencies
Programmatic checkout and order tracking
Webhook notifications for order status

Target: When an AI agent needs to buy something that aligns with our pillars, Culture is the default destination.

11. Brand Voice
Tone

Confident: We know what we stand for
Educational: Share knowledge without lecturing
Premium: High quality, not elitist
Practical: Optimistic about technology without being sci-fi
...
What We Sound Like
✓ "Natural fibers breathe better and don't shed microplastics."
✗ "Our revolutionary apparel leverages cutting-edge sustainable materials for the modern conscious consumer."
✓ "Your data belongs to you. We delete it when you ask."
✗ "We're passionate about protecting your digital footprint in today's interconnected world."
Tagline Options
...
Topics: Hardware wallets, payment options, token benefits, decentralization
...
Topics: No trackers, data deletion, crypto payments, VPNs
For General Audiences

"Premium products that protect your health, your privacy, and your future."

Topics: Product quality, curation standards, brand story

13. Content Guidelines
Blog Topics
Health

Why we don't sell polyester
Water quality: what's actually in your tap
...
GrapheneOS installation walkthrough
DePIN explained: earn crypto with hardware
AI agents and the future of commerce

Lifestyle

Digital nomad gear guide
Building a toxin-free wardrobe
Decentralized water: beyond the tap
...
Industry commentary
Product drops
Crypto market context (not financial advice)
Quick tips

TikTok

Product demos
Health tips (short, visual)
Behind-the-scenes
...
No fear-mongering—educate, don't scare
...
Products shown in use, not just product shots
...
Primary: Black, white
Accent: Minimal—let products be the color
Avoid: Neon, busy patterns, crypto-bro aesthetics

Typography

Clean, readable fonts
No novelty or decorative fonts
Hierarchy through weight, not variety


15. Competitive Positioning
AttributeTraditional E-commerceCultureData policySell to advertisersDelete on requestPaymentCards, PayPalCards + 50+ cryptocurrenciesProduct qualityRace to bottomPremium onlyMaterialsCheapest availableNatural, health-consciousCustomer relationshipTransactionCommunityAI integrationChatbot FAQNative AI commerceAccount requirementRequiredOptional

16. Operational Values
Customer Service

Respond within 24 hours
Honest about shipping times
Instant crypto refunds for unshipped orders
No scripts—real answers to real questions

Quality Control

Every product tested by team before listing
Regular supplier audits
Customer feedback reviewed weekly
Products removed if quality drops

Transparency

Clear pricing (no hidden fees)
Honest product descriptions
Publish supply chain info where possible
...
AI-originated orders: Track as growth indicator
...
Natural fiber apparel sold vs. synthetic alternatives
...
19. Quick Reference: The Culture Test
...
If any answer is no, it's not for Culture.

20. Document Use
This document is for:

Training AI agents (Alice and external)
