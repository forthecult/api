...
- **LazyWagmiProvider** is in the root layout (Wagmi loads when the auth modal is opened/preloaded; see docs/SPEED-OPTIMIZATION-AND-LAZY-LOADING.md). The invoice layout also provides its own WagmiProvider for crypto payments.
