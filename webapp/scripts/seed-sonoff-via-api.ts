...
if (!API_KEY) {
  console.error(
    "Set ADMIN_AI_API_KEY (production, uncommented in .env) or ADMIN_API_KEY. Optionally MAIN_APP_URL (default: https://forthecult.store).",
  );
  process.exit(1);
}
...
async function createBrand() {
  ...
  if (!res.ok) {
    ...
    if (
      ...
      console.log(
        "Brand Sonoff already exists or create failed (likely duplicate), continuing.",
      );
      const list = await fetch(
        `${API_BASE}/api/admin/brands?search=Sonoff&limit=5`,
        { headers },
      );
...
const PRODUCTS: ProductInput[] = [
  {
    ...
    sourceUrl:
      "https://us.itead.cc/us/products/sonoff-zigbee-wireless-switch-snzb-01p",
    features: [
  ...
  },
  {
    ...
    sourceUrl:
      "https://us.itead.cc/us/products/sonoff-zigbee-motion-sensor-snzb-03p",
    features: [
  ...
  },
  {
    ...
    sourceUrl:
      "https://us.itead.cc/us/products/sonoff-zigbee-door-window-sensor-snzb-04p",
    features: [
  ...
  },
  {
    ...
    sourceUrl:
      "https://us.itead.cc/us/products/sonoff-zigbee-temperature-and-humidity-sensor-snzb-02p",
    features: [
  ...
  },
  {
    ...
    sourceUrl:
      "https://us.itead.cc/us/products/sonoff-l3-pro-rgbic-smart-led-strip-lights",
    features: [
  ...
  },
  {
    ...
    sourceUrl:
      "https://us.itead.cc/us/products/sonoff-zigbee-smart-plug-iplug-lite",
    features: [
  ...
  },
  {
    ...
    sourceUrl:
      "https://us.itead.cc/us/products/sonoff-zigbee-smart-water-valve",
    features: [
